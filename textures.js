(function(){
    ...
    window.textures_bees=function(tex_ctx){
        ...
        tex_ctx.translate(128*15,256*4)
        tex_ctx.fillStyle='#FFD83D'
        tex_ctx.fillRect(0,0,128,128)
        tex_ctx.strokeStyle='#B88700'
        tex_ctx.lineWidth=5
        tex_ctx.strokeRect(4,4,120,120)
        tex_ctx.translate(64,64)
        tex_ctx.fillStyle='#FFF06A'
        tex_ctx.beginPath()
        tex_ctx.arc(0,0,43,0,Math.PI*2)
        tex_ctx.fill()
        tex_ctx.fillStyle='#2B2418'
        tex_ctx.beginPath()
        tex_ctx.arc(-16,-12,6,0,Math.PI*2)
        tex_ctx.arc(16,-12,6,0,Math.PI*2)
        tex_ctx.fill()
        tex_ctx.strokeStyle='#2B2418'
        tex_ctx.lineWidth=6
        tex_ctx.beginPath()
        tex_ctx.arc(0,0,25,0.25,Math.PI-0.25)
        tex_ctx.stroke()
        tex_ctx.setTransform(1,0,0,1,0,0)

        tex_ctx.translate(128*15,256*4+768)
        tex_ctx.fillStyle='#FFF06A'
        tex_ctx.fillRect(0,0,128,128)
        tex_ctx.strokeStyle='#B88700'
        tex_ctx.lineWidth=5
